...
local THEME_FILE_FALLBACK =
	debug.getinfo(1, "S").source:match("@(.+)[/\\].+$") .. "/resources/Default_5.0_unpacked.ReaperTheme"

module.COLOR = {
	Window_background = "col_main_bg",
	Window_text = "col_main_text",
	--
	Main_window_transport_background = "col_main_bg2",
	Main_window_transport_text = "col_main_text2",
	--
	Media_item_background_odd = "col_mi_bg",
	Media_item_background_even = "col_mi_bg2",
	-- list
	Window_list_background = "genlist_bg",
	Window_list_text = "genlist_fg",
	Window_list_grid_lines = "genlist_grid",
	Window_list_selected_row = "genlist_selbg",
	Window_list_selected_text = "genlist_selfg"
}
